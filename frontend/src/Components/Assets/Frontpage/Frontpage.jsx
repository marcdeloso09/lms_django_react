...
export default function Frontpage() {
  ...
  const tips = [
    ...
    "Hover Duration (>3s): Example for this is too many courses/classes enrolled on the platform. Hovering or pointing your mouse cursor for more than 3 seconds over a course, assignment, lessons/module triggers Focus Mode to help you prioritize what you only want to click",
